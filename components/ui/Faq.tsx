    ...
    return<div className="lg:px-30  text-slate-700">
                <Accordion type="single" collapsible defaultValue="item-1">
                    <AccordionItem value="item-1">
                            ...
                            <AccordionContent className="text-md sm:textlg  ">
                       ...
                       <AccordionItem value="item-2">
                            ...
                            <AccordionContent className="text-md sm:text-lg">You will get 24/7 community support through our active Discord, weekly study groups, peer code reviews, and direct mentorship opportunities
                            </AccordionContent>
                    </AccordionItem>
